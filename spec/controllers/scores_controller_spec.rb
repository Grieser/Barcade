  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved score as @score" do
        ...
        post :create, {:score => { "game_id" => "invalid value" }}, valid_session
        assigns(:score).should be_a_new(Score)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested score" do
        ...
        Score.any_instance.should_receive(:update).with({ "game_id" => "1" })
        put :update, {:id => score.to_param, :score => { "game_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the score as @score" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Score.any_instance.stub(:save).and_return(false)
        put :update, {:id => score.to_param, :score => { "game_id" => "invalid value" }}, valid_session
        assigns(:score).should eq(score)
      end
